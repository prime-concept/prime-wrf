...
final class ProfileFaqDetailHeaderView: UIView {
    private lazy var imageView: UIImageView = {
        let image = UIImageView()
        image.image = UIImage(named: "profile-header-mock")
...
extension ProfileFaqDetailHeaderView: ProgrammaticallyDesignable {
    func addSubviews() {
